...
**[Use RelayDesk to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
RelayDesk now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through RelayDesk's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — RelayDesk fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes RelayDesk's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require RelayDesk's Local Routing to stay running while in use.
...
### RelayDesk Brand Surface Unified to relaydesk.io

All in-app and README "official website" references now point at relaydesk.io as the sole official site; the release notes template also surfaces relaydesk.io.
...
The release notes template now surfaces `relaydesk.io`.

### Brand Surface

Documented `relaydesk.io` as the sole official website across READMEs and in-app references.
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `RelayDesk-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `RelayDesk-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `RelayDesk-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `RelayDesk-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `RelayDesk-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `RelayDesk-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `RelayDesk-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
