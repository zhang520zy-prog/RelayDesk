...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S relaydesk-bin`
...
访问 [Releases](https://github.com/zhang520zy-prog/RelayDesk/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/zhang520zy-prog/RelayDesk/releases/latest) 下载：

- **Windows**：`RelayDesk-Windows.msi` 或 `-Portable.zip`
- **macOS**：`RelayDesk-macOS.tar.gz` 或 `.zip`
- **Linux**：`RelayDesk-Linux.AppImage` 或 `.deb`
...
- [@zhang520zy-prog](https://github.com/zhang520zy-prog) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "relaydesk" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=relaydesk)
...
- **问题反馈**：[GitHub Issues](https://github.com/zhang520zy-prog/RelayDesk/issues)
- **讨论**：[GitHub Discussions](https://github.com/zhang520zy-prog/RelayDesk/discussions)
