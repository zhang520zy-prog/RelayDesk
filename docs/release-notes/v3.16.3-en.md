...
> 🎉 **RelayDesk has passed 100,000 Stars!**
...
- [#3789](https://github.com/zhang520zy-prog/RelayDesk/pull/3789): preserve Codex OAuth auth token on takeover, thanks @codeasier.
- [#2774](https://github.com/zhang520zy-prog/RelayDesk/pull/2774): fix model / input-token recording on Completions→Anthropic, thanks @LaoYueHanNi.
- [#4069](https://github.com/zhang520zy-prog/RelayDesk/pull/4069): fix the deadlock on relaunch after an in-app update, thanks @thisTom.
- [#4156](https://github.com/zhang520zy-prog/RelayDesk/pull/4156): fix duplicate provider terminal sessions on macOS, thanks @thisTom.
- [#3267](https://github.com/zhang520zy-prog/RelayDesk/pull/3267): fix duplicate YAML keys in the Hermes config, thanks @que3sui.
- [#1479](https://github.com/zhang520zy-prog/RelayDesk/pull/1479): fix usage script provider credential resolution, thanks @pa001024.
- [#3975](https://github.com/zhang520zy-prog/RelayDesk/pull/3975): add preset search and sorting, thanks @Nastem.
- [#4183](https://github.com/zhang520zy-prog/RelayDesk/pull/4183): adjust the preset-provider button appearance and search-box position, thanks @WangJiati.
- [#4077](https://github.com/zhang520zy-prog/RelayDesk/pull/4077): add claude-mythos-5 model pricing, thanks @osscv.
...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `RelayDesk-v3.16.3-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `RelayDesk-v3.16.3-Windows-Portable.zip` | Portable build, unzip and run                    |

### macOS

| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `RelayDesk-v3.16.3-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `RelayDesk-v3.16.3-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `RelayDesk-v3.16.3-macOS.tar.gz` | For Homebrew install and auto-update                  |
