...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S relaydesk-bin`
...
Visit [Releases](https://github.com/zhang520zy-prog/RelayDesk/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `relaydesk://` protocol
...
v3.7.0 represents a shift in RelayDesk's positioning:
...
Visit [Releases](https://github.com/zhang520zy-prog/RelayDesk/releases/latest) to download:

- **Windows**: `RelayDesk-Windows.msi` or `-Portable.zip`
- **macOS**: `RelayDesk-macOS.tar.gz` or `.zip`
- **Linux**: `RelayDesk-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S relaydesk-bin`
...
- [@zhang520zy-prog](https://github.com/zhang520zy-prog) - From developer to issue responder
...
[Register with "relaydesk" code for 10% discount](https://www.packyapi.com/register?aff=relaydesk)
...
- **Issues**: [GitHub Issues](https://github.com/zhang520zy-prog/RelayDesk/issues)
- **Discussions**: [GitHub Discussions](https://github.com/zhang520zy-prog/RelayDesk/discussions)
