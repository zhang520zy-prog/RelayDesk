...
RelayDesk v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `RelayDesk-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `RelayDesk-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `RelayDesk-v3.8.0-Linux.AppImage` or `.deb`
...
- [@zhang520zy-prog](https://github.com/zhang520zy-prog) - Bug fixes and feature enhancements
...
[Use code "relaydesk" for 10% off registration](https://www.packyapi.com/register?aff=relaydesk)
...
- **Issue Reports**: [GitHub Issues](https://github.com/zhang520zy-prog/RelayDesk/issues)
