...
**[中文更新说明 Chinese Documentation →](https://github.com/zhang520zy-prog/RelayDesk/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `RelayDesk-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `RelayDesk-v3.6.0-Windows.msi`
- **Portable**: `RelayDesk-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `RelayDesk-v3.6.0-Linux.AppImage`
- **Debian**: `RelayDesk-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/zhang520zy-prog/RelayDesk/compare/v3.5.1...v3.6.0
