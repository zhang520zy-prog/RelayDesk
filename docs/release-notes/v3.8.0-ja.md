...
RelayDesk v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/zhang520zy-prog/RelayDesk/releases/latest) から入手:

- **Windows**: `RelayDesk-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `RelayDesk-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `RelayDesk-v3.8.0-Linux.AppImage` または `.deb`
...
- [@zhang520zy-prog](https://github.com/zhang520zy-prog) - バグ修正と機能拡張
...
[登録時に「relaydesk」で 10% オフ](https://www.packyapi.com/register?aff=relaydesk)
...
- **Issue**: [GitHub Issues](https://github.com/zhang520zy-prog/RelayDesk/issues)
