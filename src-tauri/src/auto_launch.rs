...
/// 将 `/path/to/RelayDesk.app/Contents/MacOS/RelayDesk` 转换为 `/path/to/RelayDesk.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/RelayDesk.app/Contents/MacOS/RelayDesk");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/RelayDesk.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/RelayDesk.app/Contents/MacOS/RelayDesk");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/RelayDesk.app"
            ))
        );
    }
