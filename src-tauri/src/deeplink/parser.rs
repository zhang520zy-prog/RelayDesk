...
//!
//! Parses relaydesk:// URLs into DeepLinkImportRequest structures.
...
/// Parse a relaydesk:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// relaydesk://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "relaydesk" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'relaydesk', got '{scheme}'"
        )));
    }
