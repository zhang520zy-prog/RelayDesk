//! Deep link import functionality for RelayDesk
//!
//! This module implements the relaydesk:// protocol for importing configurations
...
///
/// Represents a parsed relaydesk:// URL ready for processing.
